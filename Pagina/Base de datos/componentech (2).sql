...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 25-11-2020 a las 20:22:09
...
('msjaramillo824@misena.edu.co', '11'),
('msjaramillo824sssssss@misena.edu.co', '123'),
('msjo4@misena.edu.co', 'Medico'),
...
(2152, '2020-01-23', 2193000, 2609670, 2, 227142548, 8),
(2355, '2020-04-11', 5290000, 1005100, 2, 194117223, 8),
...
(155125, 'Marlon', 'Jaramillo', '2020-11-04', 17, '3212855600', 'diag 43# 1a 20 este', 'msjaramillo824@misena.edu.co', 2, 3, 9),
(194117223, 'Julian', 'Sprules', '1989-08-27', 13, '674 787 4516', '77 Dakota Junction', 'tsprules4@weebly.com', 3, 3, 9),
...
(1000035428, 'Juan', 'sdadsa', '2020-11-04', 0, '', '', '', 2, 2, 9),
(1000035428, 'Madsa', 'Yurman', '2020-11-30', 57, '45456465', 'diag 43# 1a 20 este', 'msjaramillo824sssssss@misena.edu.co', 2, 3, 9),
(1000035428, 'Carlos', 'Yurman', '2020-11-23', 23, '45456465', 'diag 43# 1a 20 este', 'msjo4@misena.edu.co', 2, 4, 9),
...
(3653385010, 'Pablo', 'Yurman', '1999-06-09', 45, '353 684 0247', '500 Di Loreto Lane', 'cyurmanovev7@geocities.com', 2, 4, 9),
...
--
ALTER TABLE `usuario`
  ADD PRIMARY KEY (`documento`,`TIPODOCUMENTO_idTipo`),
...
--
ALTER TABLE `producto`
  MODIFY `idProducto` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1033;

--
-- AUTO_INCREMENT de la tabla `proveedor`
--
ALTER TABLE `proveedor`
  MODIFY `idProveedor` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
