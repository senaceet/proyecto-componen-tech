				...
				while ($producto = $con_productos->fetch_array()) { ?>
					<div class="producto item">
						...
						<div class="datos">
							...
							<h3><?php echo $producto['productoNombre']; ?></a></h3>
						...
						<form  action="" method="post">
							...
							<a class="btn-carrito" type="button" name="addCarrito" href="producto.php?p=<?php echo $producto['idProducto'] ?>"> VER DETALLES 📃</a>
						</form>
